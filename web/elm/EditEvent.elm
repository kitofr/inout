...
import DateUtil exposing (DateRecord, dateStr, timeStr, timeTuple)
...
editEvent : { device : String, id : Int, inserted_at : DateRecord, location : String, status : String, updated_at : DateRecord } -> Html Msg
editEvent event =
    let
        marginLeft px =
