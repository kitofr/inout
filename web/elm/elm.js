...
var _user$project$Charts$barChart = function (dayCount) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 350 110'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width('250px'),
				_1: {ctor: '[]'}
			}
		},
		A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$width('9'),
												_1: {
													ctor: '::',
...
var _user$project$Types$sortEventsDesc = function (events) {
	return A2(_user$project$Types$sortEvents, events, _rluiten$elm_date_extra$Date_Extra_Compare$SameOrBefore);
};
...
var _user$project$Types$Model = F5(
	function (a, b, c, d, e) {
		return {events: a, hostUrl: b, checkInAt: c, edit: d, timeSinceLastCheckIn: e};
	});
...
var _user$project$Types$LoadEvents = function (a) {
	return {ctor: 'LoadEvents', _0: a};
};
var _user$project$Types$CreateEvent = function (a) {
...
var _user$project$Types$EditItem = function (a) {
	return {ctor: 'EditItem', _0: a};
};
var _user$project$Types$Load = {ctor: 'Load'};
var _user$project$Types$CheckOut = {ctor: 'CheckOut'};
var _user$project$Types$CheckIn = {ctor: 'CheckIn'};

var _user$project$View$editEvent = function (event) {
	var _p0 = A2(_elm_lang$core$Debug$log, 'edit event', event);
	return A2(
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'. ',
								A2(_elm_lang$core$Basics_ops['++'], event.status, ' ')))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_0: _elm_lang$html$Html_Attributes$placeholder(
							A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_us$config, '%a %-d %b %Y at  %-H:%M:%S', event.inserted_at)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Types$Update(event)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Types$Delete(event)),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$View$edit = function (dayItem) {
	return A2(
		...
		A2(_elm_lang$core$List$map, _user$project$View$editEvent, dayItem.events));
};
var _user$project$View$viewTimePeriod = function (_p1) {
	var _p2 = _p1;
	return A2(
...
var _user$project$View$viewTimeSinceLastCheckIn = function (t) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$View$viewTimePeriod,
		_user$project$DateUtil$timePeriods(t));
};
var _user$project$View$desc = F2(
	function (a, b) {
		var _p3 = A2(_elm_lang$core$Basics$compare, a, b);
		switch (_p3.ctor) {
			case 'LT':
				return _elm_lang$core$Basics$GT;
			case 'EQ':
...
var _user$project$View$sortedDayItems = function (events) {
	...
	return A2(
		...
		F2(
			function (a, b) {
				return A3(_user$project$DateUtil$sortDates, _rluiten$elm_date_extra$Date_Extra_Compare$SameOrBefore, a.date, b.date);
			}),
		dayItems);
};
...
var _user$project$View$totalsRect = function (x) {
	var data = _elm_lang$core$Tuple$second(x);
	var year = function () {
		var _p4 = _elm_lang$core$List$head(data);
		if (_p4.ctor === 'Just') {
			return _elm_lang$core$Date$year(_p4._0.date);
		} else {
			return 0;
		}
	}();
	return {
		year: year,
		month: _user$project$DateUtil$toMonthStr(
...
var _user$project$View$monthItem = function (month) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
								_elm_lang$core$Basics$toString(month.year)))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$DateUtil$periodToStr(month.total)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(month.count)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Charts$barChart(month.monthlyDayCount),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$monthlyTotals = function (sorted) {
	var perMonth = A2(
		_user$project$Seq$groupBy,
		function (x) {
	...
	var monthTotals = A2(
		_elm_lang$core$List$map,
		_user$project$View$totalsRect,
		_elm_lang$core$Dict$toList(perMonth));
	var sortedMonthTotals = A2(
		_elm_lang$core$List$sortWith,
		F2(
			function (a, b) {
				var _p5 = _elm_lang$core$Native_Utils.cmp(a.year, b.year) > 0;
				if (_p5 === true) {
					return _elm_lang$core$Basics$LT;
				} else {
					return _elm_lang$core$Basics$GT;
...
var _user$project$View$yearTab = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$html$Html$span,
		{
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$monthlyTotals(
					_user$project$View$sortedDayItems(_p7._1)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$dayItem = function (day) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Types$EditItem(day)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View$last5 = function (sorted) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$View$dayItem,
						A2(_elm_lang$core$List$take, 5, sorted))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$eventsComponent = function (events) {
	var monthlySorted = _user$project$View$sortedDayItems(events);
	var groupedByYear = A2(
		_elm_lang$core$List$sortWith,
		F2(
			function (_p9, _p8) {
				var _p10 = _p9;
				var _p11 = _p8;
				return A2(_user$project$View$desc, _p10._0, _p11._0);
			}),
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$last5(monthlySorted),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					A2(_elm_lang$core$List$map, _user$project$View$yearTab, groupedByYear)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$view = function (model) {
	var shouldEdit = function () {
		var _p12 = model.edit;
		if (_p12.ctor === 'Just') {
			return _user$project$View$edit(_p12._0);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
	...
	var time = A2(
		_elm_lang$core$Debug$log,
		'time',
		_user$project$DateUtil$timePeriods(model.timeSinceLastCheckIn));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				},
				{
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Load),
										_1: {ctor: '[]'}
									}
								},
								{
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$CheckIn),
											_1: {ctor: '[]'}
										}
									},
									{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$CheckOut),
												_1: {ctor: '[]'}
											}
										},
										{
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$View$viewTimeSinceLastCheckIn(model.timeSinceLastCheckIn)),
						_1: {
							ctor: '::',
							_0: shouldEdit,
							_1: {
								ctor: '::',
								_0: _user$project$View$eventsComponent(model.events),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$View$eventItem = function (event) {
	var color = _elm_lang$core$Native_Utils.eq(event.status, 'check-in') ? 'success' : 'info';
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'list-group-item list-group-item-', color)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(event.status),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$DateUtil$dateToMonthStr(event.inserted_at)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(event.device),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(event.location),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
