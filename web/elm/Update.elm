...
import Api exposing (..)
import DateUtil exposing (sortDates, parseStringDate, zeroPad)
        ...
        DateUpdated event date ->
            let
                createDateFrom d str =
                  let h = Date.hour d |> toString |> zeroPad
                      m = Date.minute d |> toString |> zeroPad
                      s = Date.second d |> toString |> zeroPad
                  in
                    str ++ " " ++ h ++ ":" ++ m ++ ":" ++ s
