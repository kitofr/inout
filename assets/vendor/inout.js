...
var _user$project$DateUtil$timePeriods = function (t) {
	var addLeadingZeros = function (n) {
		return A3(
			_elm_lang$core$String$padLeft,
			2,
			_elm_lang$core$Native_Utils.chr('0'),
	...
	var days = _elm_lang$core$Basics$floor(t / (((1000 * 60) * 60) * 24));
	var hours = A2(
		_elm_lang$core$Basics_ops['%'],
		_elm_lang$core$Basics$floor(t / ((1000 * 60) * 60)),
		24);
	var minutes = A2(
		_elm_lang$core$Basics_ops['%'],
		_elm_lang$core$Basics$floor((t / 1000) / 60),
		60);
	var seconds = A2(
		_elm_lang$core$Basics_ops['%'],
		_elm_lang$core$Basics$floor(t / 1000),
		60);
	return A3(
		_elm_lang$core$List$map2,
		F2(
...
var _user$project$DateUtil$periodToStr = function (period) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(period.hour),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'h ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(period.minute),
				A2(
					_elm_lang$core$Basics_ops['++'],
					'min ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(period.second),
						'sec')))));
};
var _user$project$DateUtil$addTime = function (t) {
	return {
		ctor: '_Tuple2',
		_0: A2(_elm_lang$core$Basics_ops['%'], t, 60),
		_1: (t / 60) | 0
	};
};
var _user$project$DateUtil$addTimeDurations = F2(
	function (a, b) {
		var mil = _user$project$DateUtil$addTime(a.millisecond + b.millisecond);
		var sec = _user$project$DateUtil$addTime(
			(a.second + b.second) + _elm_lang$core$Tuple$second(mil));
		var min = _user$project$DateUtil$addTime(
			(a.minute + b.minute) + _elm_lang$core$Tuple$second(sec));
		var hour = (a.hour + b.hour) + _elm_lang$core$Tuple$second(min);
		return {
			millisecond: _elm_lang$core$Tuple$first(mil),
			second: _elm_lang$core$Tuple$first(sec),
			minute: _elm_lang$core$Tuple$first(min),
			hour: hour
		};
	});
var _user$project$DateUtil$emptyTimeDuration = {hour: 0, minute: 0, second: 0, millisecond: 0};
var _user$project$DateUtil$toTimeDuration = function (duration) {
	return {hour: duration.hour, minute: duration.minute, second: duration.second, millisecond: duration.millisecond};
};
var _user$project$DateUtil$dateToMonthStr = function (date) {
	var month = function () {
	...
	var day = function () {
		var _p1 = _elm_lang$core$Date$dayOfWeek(date);
		switch (_p1.ctor) {
			case 'Mon':
				return 'Mon';
			case 'Tue':
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Date$day(date)),
				A2(_elm_lang$core$Basics_ops['++'], ' ', month))));
};
var _user$project$DateUtil$monthOrder = function (date) {
...
var _user$project$DateUtil$toMonthStr = function (num) {
	var _p3 = num;
	switch (_p3) {
		case 1:
			return 'Jan';
...
var _user$project$DateUtil$sortDates = F3(
	function (order, a, b) {
		var _p4 = A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, order, a, b);
		if (_p4 === true) {
...
var _user$project$DateUtil$timeTuple = function (date) {
	var sec = _user$project$DateUtil$zeroPad(
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$second(date)));
	var min = _user$project$DateUtil$zeroPad(
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$minute(date)));
	var hour = _user$project$DateUtil$zeroPad(
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$hour(date)));
...
var _user$project$DateUtil$dateTuple = function (date) {
	var day = _user$project$DateUtil$zeroPad(
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$day(date)));
	var month = _user$project$DateUtil$zeroPad(
		_elm_lang$core$Basics$toString(
			_rluiten$elm_date_extra$Date_Extra_Core$monthToInt(
				_elm_lang$core$Date$month(date))));
...
var _user$project$DateUtil$TimeDuration = F4(
	function (a, b, c, d) {
		return {hour: a, minute: b, second: c, millisecond: d};
	});

var _user$project$Types$emptyEvent = function () {
	var date = function () {
		var _p0 = _elm_lang$core$Date$fromString('2000-01-01');
		if (_p0.ctor === 'Ok') {
			return _p0._0;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Types',
				{
					...
					end: {line: 87, column: 52}
				},
				_p0)('Can\'t create date');
		}
	}();
	return {id: 0, status: 'empty', location: 'elm', device: 'none', posix: 0, inserted_at: date, updated_at: date};
}();
var _user$project$Types$sortEvents = F2(
	function (events, order) {
		return A2(
			_elm_lang$core$List$sortWith,
			F2(
				function (a, b) {
					return A3(_user$project$DateUtil$sortDates, order, a.inserted_at, b.inserted_at);
				}),
			events);
	});
var _user$project$Types$timeDifference = function (coll) {
	var sorted = A2(_user$project$Types$sortEvents, coll, _rluiten$elm_date_extra$Date_Extra_Compare$SameOrBefore);
	var first = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Types$emptyEvent,
	...
	return A2(_rluiten$elm_date_extra$Date_Extra_Duration$diff, first.inserted_at, last.inserted_at);
};
var _user$project$Types$Flags = function (a) {
	return {hostUrl: a};
};
var _user$project$Types$Event = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, status: b, location: c, device: d, posix: e, inserted_at: f, updated_at: g};
	});
var _user$project$Types$Contract = function (a) {
	return {name: a};
};
var _user$project$Types$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {events: a, hostUrl: b, checkInAt: c, page: d, edit: e, timeSinceLastCheckIn: f, currentTab: g, contract: h};
	});
var _user$project$Types$DayItem = F5(
	function (a, b, c, d, e) {
		return {date: a, dateStr: b, diff: c, dayNumber: d, events: e};
	});
var _user$project$Types$Invoice = F3(
	function (a, b, c) {
		return {ctor: 'Invoice', _0: a, _1: b, _2: c};
	});
var _user$project$Types$Home = {ctor: 'Home'};

var _user$project$ApiMsgs$LoadContract = function (a) {
	return {ctor: 'LoadContract', _0: a};
};
var _user$project$ApiMsgs$DeleteEvent = function (a) {
	return {ctor: 'DeleteEvent', _0: a};
};
var _user$project$ApiMsgs$UpdateEvent = function (a) {
	return {ctor: 'UpdateEvent', _0: a};
};
var _user$project$ApiMsgs$LoadEvents = function (a) {
	return {ctor: 'LoadEvents', _0: a};
};
var _user$project$ApiMsgs$CheckEvent = function (a) {
	return {ctor: 'CheckEvent', _0: a};
};

var _user$project$ViewMsgs$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$ViewMsgs$TimeUpdated = F2(
	function (a, b) {
		return {ctor: 'TimeUpdated', _0: a, _1: b};
	});
var _user$project$ViewMsgs$TabClicked = function (a) {
	return {ctor: 'TabClicked', _0: a};
};
var _user$project$ViewMsgs$MinuteSelected = F2(
	function (a, b) {
		return {ctor: 'MinuteSelected', _0: a, _1: b};
	});
var _user$project$ViewMsgs$Load = {ctor: 'Load'};
var _user$project$ViewMsgs$HourSelected = F2(
	function (a, b) {
		return {ctor: 'HourSelected', _0: a, _1: b};
	});
var _user$project$ViewMsgs$GoHome = {ctor: 'GoHome'};
var _user$project$ViewMsgs$EditItem = function (a) {
	return {ctor: 'EditItem', _0: a};
};
var _user$project$ViewMsgs$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$ViewMsgs$DateUpdated = F2(
	function (a, b) {
		return {ctor: 'DateUpdated', _0: a, _1: b};
	});
var _user$project$ViewMsgs$CreateInvoice = F3(
	function (a, b, c) {
		return {ctor: 'CreateInvoice', _0: a, _1: b, _2: c};
	});
var _user$project$ViewMsgs$CloseEdit = {ctor: 'CloseEdit'};
var _user$project$ViewMsgs$CheckOut = {ctor: 'CheckOut'};
var _user$project$ViewMsgs$CheckIn = {ctor: 'CheckIn'};

var _user$project$Msgs$SetRoute = function (a) {
	return {ctor: 'SetRoute', _0: a};
};
var _user$project$Msgs$ViewEvent = function (a) {
	return {ctor: 'ViewEvent', _0: a};
};
var _user$project$Msgs$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Msgs$ApiEvent = function (a) {
	return {ctor: 'ApiEvent', _0: a};
};

var _user$project$Api$createCheck = function (record) {
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'status',
							_1: _elm_lang$core$Json_Encode$string(record.status)
						},
						_1: {
							ctor: '::',
							_0: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'device',
									_1: _elm_lang$core$Json_Encode$string('internetz')
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Api$cetTime = function (str) {
	var withTimeZone = A2(_elm_lang$core$Basics_ops['++'], str, '+02:00');
	var _p0 = _elm_lang$core$Date$fromString(withTimeZone);
	if (_p0.ctor === 'Ok') {
		return _elm_lang$core$Json_Decode$succeed(_p0._0);
	} else {
		return _elm_lang$core$Json_Decode$fail(_p0._0);
...
var _user$project$Api$decodeEvent = A2(
	...
	A2(
		...
		A2(
			...
			A2(_elm_lang$core$Json_Decode$field, 'posix', _elm_lang$core$Json_Decode$int)),
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_user$project$Api$cetTime,
...
var _user$project$Api$decodeEvents = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	_elm_lang$core$Json_Decode$succeed(_elm_lang$core$Basics$identity),
	A2(
		_elm_lang$core$Json_Decode$field,
		'events',
		_elm_lang$core$Json_Decode$list(_user$project$Api$decodeEvent)));
var _user$project$Api$decodeContract = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Types$Contract,
	A2(_elm_lang$core$Json_Decode$field, 'client', _elm_lang$core$Json_Decode$string));
var _user$project$Api$decodeContracts = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	_elm_lang$core$Json_Decode$succeed(_elm_lang$core$Basics$identity),
	A2(
		_elm_lang$core$Json_Decode$field,
		'contracts',
		_elm_lang$core$Json_Decode$list(_user$project$Api$decodeContract)));
var _user$project$Api$deleteRequest = function (url) {
	return _elm_lang$http$Http$request(
		{
			method: 'DELETE',
			headers: {ctor: '[]'},
			...
			expect: _elm_lang$http$Http$expectStringResponse(
				function (_p1) {
					return _elm_lang$core$Result$Ok('DELETED');
				}),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
};
var _user$project$Api$deleteEvent = F2(
	function (event, hostUrl) {
		return A2(
			_elm_lang$http$Http$send,
			function (_p2) {
				return _user$project$Msgs$ApiEvent(
					_user$project$ApiMsgs$DeleteEvent(_p2));
			},
			_user$project$Api$deleteRequest(
				A2(
					_elm_lang$core$Basics_ops['++'],
					hostUrl,
					A2(
...
var _user$project$Api$encodeEvent = function (_p3) {
	var _p4 = _p3;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
				...
				_1: _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'id',
							_1: _elm_lang$core$Json_Encode$int(_p4.id)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'status',
								_1: _elm_lang$core$Json_Encode$string(_p4.status)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'location',
									_1: _elm_lang$core$Json_Encode$string(_p4.location)
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: _elm_lang$core$Json_Encode$string(
											_rluiten$elm_date_extra$Date_Extra_Format$isoStringNoOffset(_p4.inserted_at))
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_0: 'updated_at',
											_1: _elm_lang$core$Json_Encode$string(
												_rluiten$elm_date_extra$Date_Extra_Format$isoStringNoOffset(_p4.updated_at))
										},
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Api$updateRequest = F2(
	function (url, event) {
		return _elm_lang$http$Http$request(
			{
				method: 'PUT',
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$Api$encodeEvent(event)),
				expect: _elm_lang$http$Http$expectStringResponse(
					function (_p5) {
						return _elm_lang$core$Result$Ok('UPDATED');
					}),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
...
var _user$project$Api$getEvents = function (hostUrl) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$Basics_ops['++'], hostUrl, '/events.json'),
...
var _user$project$Api$loadContract = function (hostUrl) {
	...
	return A2(
		...
		A2(
			_elm_lang$http$Http$get,
			A2(_elm_lang$core$Basics_ops['++'], hostUrl, '/contracts.json'),
			_user$project$Api$decodeContracts));
};
var _user$project$Api$post = F3(
...
var _user$project$Api$check = F3(
	function (inOrOut, contract, hostUrl) {
		var rec = _user$project$Api$createCheck(
			{
				status: A2(_elm_lang$core$Basics_ops['++'], 'check-', inOrOut),
				location: contract
			});
		return A3(
			_user$project$Api$post,
			_elm_lang$core$Json_Decode$succeed(''),
			A2(_elm_lang$core$Basics_ops['++'], hostUrl, '/events'),
			rec);
	});
				...
				if (_p11._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{edit: _elm_lang$core$Maybe$Nothing}),
						_1: _user$project$Api$getEvents(model.hostUrl)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Seq$groupBy = F2(
	function (fun, coll) {
		var reducer = F2(
			function (x, acc) {
				var key = fun(x);
				var list = A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					A2(_elm_lang$core$Dict$get, key, acc));
				return A3(
					_elm_lang$core$Dict$insert,
					key,
					{ctor: '::', _0: x, _1: list},
		...
		return A3(_elm_lang$core$List$foldl, reducer, _elm_lang$core$Dict$empty, coll);
	});
var _user$project$Seq$nth = F3(
	function (n, lst, def) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			def,
...
var _user$project$Charts$rainbowColors = {
	ctor: '::',
	_0: '#f80c12',
	_1: {
		ctor: '::',
...
var _user$project$Charts$barChart = function (dayCount) {
	var barSize = 12;
	var offSet = 3 * barSize;
	var viewSize = barSize * 26;
	var viewSizeStr = _elm_lang$core$Basics$toString(viewSize);
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			...
			_0: _elm_lang$svg$Svg_Attributes$viewBox(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'0 0 ',
					A2(_elm_lang$core$Basics_ops['++'], viewSizeStr, ' 110'))),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width(
					A2(_elm_lang$core$Basics_ops['++'], viewSizeStr, 'px')),
				_1: {ctor: '[]'}
			}
		},
		A2(
			...
			F2(
				function (i, day) {
					var color = A3(
						_user$project$Seq$nth,
						A2(
							_elm_lang$core$Basics_ops['%'],
							day.hour,
							_elm_lang$core$List$length(_user$project$Charts$rainbowColors)),
						_user$project$Charts$rainbowColors,
						'#442299');
					return A2(
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$svg$Svg_Attributes$x(
											_elm_lang$core$Basics$toString((i * barSize) + offSet)),
										_1: {
											ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$width(
													_elm_lang$core$Basics$toString(barSize - 2)),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$height(
														A2(
															_elm_lang$core$Basics_ops['++'],
															_elm_lang$core$Basics$toString(1 + day.hour),
															'0')),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$transform('rotate(180) translate(-300 -100)'),
														_1: {ctor: '[]'}
													}
												}
											}
			...
			_elm_lang$core$List$reverse(dayCount)));
};

var _user$project$HtmlExtra_ops = _user$project$HtmlExtra_ops || {};
_user$project$HtmlExtra_ops['=>'] = F2(
	function (a, b) {
		return {ctor: '_Tuple2', _0: a, _1: b};
	});

var _user$project$InputExtra$timeOption = F2(
	function (selectedValue, time) {
		...
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$selected(current),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$InputExtra$timeInput = F3(
	function (attr, val, range) {
		return A2(
			_elm_lang$html$Html$select,
			attr,
			A2(
				_elm_lang$core$List$map,
				_user$project$InputExtra$timeOption(val),
				range));
	});
var _user$project$InputExtra$dateInput = F2(
			...
			A2(
				...
				attr,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$min('2017-01-01'),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$EditEvent$onChange = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$targetValue));
};
var _user$project$EditEvent$editEvent = function (event) {
	var _p0 = _user$project$DateUtil$timeTuple(event.inserted_at);
	var hourPart = _p0._0;
	var minutePart = _p0._1;
	...
	var marginLeft = function (px) {
		return _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: A2(
					_user$project$HtmlExtra_ops['=>'],
					'margin-left',
					A2(
						_elm_lang$core$Basics_ops['++'],
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_elm_lang$html$Html$span,
						{
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: A2(_user$project$HtmlExtra_ops['=>'], 'width', '30px'),
									_1: {
										ctor: '::',
										_0: A2(_user$project$HtmlExtra_ops['=>'], 'display', 'inline-block'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$InputExtra$dateInput,
							{
								ctor: '::',
								_0: marginLeft(10),
								_1: {
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p2) {
											return _user$project$Msgs$ViewEvent(
												A2(_user$project$ViewMsgs$DateUpdated, event, _p2));
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											_user$project$DateUtil$dateStr(event.inserted_at)),
										_1: {ctor: '[]'}
									}
								}
							},
						...
						_1: {
							ctor: '::',
							_0: A3(
								_user$project$InputExtra$timeInput,
								{
									ctor: '::',
									_0: marginLeft(10),
									_1: {
										ctor: '::',
										_0: _user$project$EditEvent$onChange(
											function (_p3) {
												return _user$project$Msgs$ViewEvent(
													A2(_user$project$ViewMsgs$HourSelected, event, _p3));
											}),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(hourPart),
											_1: {ctor: '[]'}
										}
									}
								},
									...
									_user$project$InputExtra$timeInput,
									{
										...
										_1: {
											...
											_0: _user$project$EditEvent$onChange(
												function (_p4) {
													return _user$project$Msgs$ViewEvent(
														A2(_user$project$ViewMsgs$MinuteSelected, event, _p4));
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(minutePart),
												_1: {ctor: '[]'}
											}
										}
									},
											...
											_1: {
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Msgs$ViewEvent(
															_user$project$ViewMsgs$Update(event))),
													_1: {ctor: '[]'}
												}
											}
										},
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Msgs$ViewEvent(
															_user$project$ViewMsgs$Delete(event))),
													_1: {ctor: '[]'}
												}
											},
											{
...
var _user$project$EditEvent$edit = function (dayItem) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Edit: ', dayItem.dateStr)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$HtmlExtra_ops['=>'], 'margin-left', '20px'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Msgs$ViewEvent(_user$project$ViewMsgs$CloseEdit)),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: A2(
						...
						A2(_elm_lang$core$List$map, _user$project$EditEvent$editEvent, dayItem.events)),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Route$Invoice = {ctor: 'Invoice'};
...
var _user$project$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Route$Invoice,
				_evancz$url_parser$UrlParser$s('invoice')),
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Update$setRoute = F2(
	function (location, model) {
		var route = A2(
			...
			A2(_evancz$url_parser$UrlParser$parsePath, _user$project$Route$route, location));
		var _p0 = route;
		if (_p0.ctor === 'Home') {
			return _elm_lang$core$Native_Utils.update(
				model,
...
var _user$project$Update$createDateFromDate = F2(
	function (d, str) {
		var s = _user$project$DateUtil$zeroPad(
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Date$second(d)));
		var m = _user$project$DateUtil$zeroPad(
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Date$minute(d)));
		var h = _user$project$DateUtil$zeroPad(
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Date$hour(d)));
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Update$createDateFromTime = F2(
	function (d, str) {
		var date_ = _user$project$DateUtil$dateStr(d);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			date_,
			A2(_elm_lang$core$Basics_ops['++'], 'T', str));
	});
var _user$project$Update$changeEvent = F2(
	function (lst, e) {
		return A2(
			_elm_lang$core$List$map,
			function (ev) {
				return _elm_lang$core$Native_Utils.eq(ev.id, e.id) ? e : ev;
			},
			lst);
	});
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'ApiEvent':
				return A2(_user$project$Api$update, _p5._0, model);
			case 'ViewEvent':
				switch (_p5._0.ctor) {
					case 'TabClicked':
						return {
					...
					case 'Delete':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_user$project$Api$deleteEvent, _p5._0._0, model.hostUrl)
						};
					case 'EditItem':
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									edit: _elm_lang$core$Maybe$Just(_p5._0._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'CheckIn':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_user$project$Api$check, 'in', model.contract.name, model.hostUrl)
						};
					case 'CheckOut':
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_user$project$Api$check, 'out', model.contract.name, model.hostUrl)
						};
					case 'GoHome':
						return {
							ctor: '_Tuple2',
					...
					case 'HourSelected':
						var _p16 = _p5._0._0;
						var dt = A2(_user$project$Update$updateHour, _p16.inserted_at, _p5._0._1);
						var event_ = _elm_lang$core$Native_Utils.update(
							_p16,
							{inserted_at: dt});
						var edit = function () {
							...
							if (_p14.ctor === 'Just') {
								...
								return _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										_p15,
										{
											events: A2(_user$project$Update$changeEvent, _p15.events, event_)
										}));
							} else {
								return _elm_lang$core$Maybe$Nothing;
							}
			...
			case 'SetRoute':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Update$setRoute, _p5._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var min2Millsec = function (min) {
					return _elm_lang$core$Basics$toFloat((60 * 1000) * min);
				};
				var withTimeZone = function (x) {
					return min2Millsec(x * -1);
				}(
					_rluiten$elm_date_extra$Date_Extra_Create$getTimezoneOffset(
						_elm_lang$core$Date$fromTime(model.checkInAt)));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{timeSinceLastCheckIn: (_p5._0 - model.checkInAt) - withTimeZone}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});

var _user$project$Invoice$sumInvoice = function (invoice) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (row, total) {
				var _p0 = row;
				if (_p0.ctor === 'HourlyReporting') {
					return (total + (_p0._0._1 * _elm_lang$core$Basics$toFloat(_p0._0._2))) + _p0._0._4;
				} else {
					return (total + (_p0._0._1 * _elm_lang$core$Basics$toFloat(_p0._0._2))) + _p0._0._4;
				}
			}),
...
var _user$project$Invoice$invoiceHeader = function (invoiceNumber) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('faktura'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src('images/agical_128x40.png'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Faktura ',
										_elm_lang$core$Basics$toString(invoiceNumber))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Invoice$pbv = F2(
	function (txt, value) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('lbl'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], txt, ': ')),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Invoice$paymentInfoSection = function (invoice) {
	var total = _user$project$Invoice$sumInvoice(invoice);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('payment-info-section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$Invoice$pbv, 'Totalsumma', total),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Invoice$pbv, 'Moms', 25 * total),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Invoice$pbv, 'Totalt inkl moms', 1.25 * total),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$Invoice$pbsv = F2(
	function (txt, value) {
		return A2(
			_elm_lang$html$Html$p,
			{ctor: '[]'},
...
var _user$project$Invoice$invoiceDayRow = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('invoice-row'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_user$project$Invoice$pbsv, 'Beskrivning ', _p2._0),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Invoice$pbv, 'Dagspris ', _p2._1),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Invoice$pbv, 'Antal dagar ', _p2._2),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Invoice$pbsv, 'Dagarna avser: ', _p2._3),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Invoice$pbv, 'Övrig summa ', _p2._4),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Invoice$invoiceHourRow = function (_p3) {
	var _p4 = _p3;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		{
			ctor: '::',
			_0: A2(_user$project$Invoice$pbsv, 'Beskrivning ', _p4._0),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Invoice$pbv, 'Timpris ', _p4._1),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Invoice$pbv, 'Antal timmar ', _p4._2),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Invoice$pbsv, 'Timmarna avser: ', _p4._3),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Invoice$pbv, 'Övrig summa ', _p4._4),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Invoice$invoiceRows = function (invoice) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			...
			function (row) {
				var _p5 = row;
				if (_p5.ctor === 'DailyReporting') {
					return _user$project$Invoice$invoiceDayRow(_p5._0);
				} else {
					return _user$project$Invoice$invoiceHourRow(_p5._0);
				}
			},
			invoice.rows));
};
var _user$project$Invoice$pb = function (txt) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
...
var _user$project$Invoice$paymentInfo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('payment-info'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _user$project$Invoice$pb('Betalningsinformation'),
		_1: {
			ctor: '::',
			_0: _user$project$Invoice$pb('Bankgiro 5345-5226'),
			_1: {
				ctor: '::',
				_0: _user$project$Invoice$pb('Organisationsnummer 556667-2597'),
				_1: {
					ctor: '::',
					_0: _user$project$Invoice$pb('Ange fakturanummer vid betalning.'),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$p,
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Vid försenad betalning debiteras dröjsmålsränta med 15%'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _user$project$Invoice$invoiceContractDetails = F2(
	function (invoice, contract) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('invoice-info'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(_user$project$Invoice$pbv, 'Fakturanummer', invoice.number),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Invoice$pbsv, 'Fakturadatum', invoice.date),
									_1: {
										ctor: '::',
										_0: _user$project$Invoice$pb(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Bet.Villkor ',
												A2(_elm_lang$core$Basics_ops['++'], invoice.paymentDue, ' dagar netto'))),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Invoice$pbsv, 'Referens Agical', invoice.reference),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_user$project$Invoice$pbsv, 'Kund', contract.customer),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Invoice$pbsv, 'Referens', contract.reference),
										_1: {
											ctor: '::',
											_0: _user$project$Invoice$pb('Adress: '),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$div,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('adress tab'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(contract.adress),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: _elm_lang$html$Html$text(
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				contract.postNumber,
																				A2(_elm_lang$core$Basics_ops['++'], ' ', contract.county))),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
...
var _user$project$Invoice$ph = function (txt) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
...
var _user$project$Invoice$footer = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _user$project$Invoice$pb('Kontakt'),
				_1: {
					ctor: '::',
					_0: _user$project$Invoice$ph('faktura@agical.se'),
					_1: {
						ctor: '::',
						_0: _user$project$Invoice$ph('https://www.agical.se'),
						_1: {
							ctor: '::',
							_0: _user$project$Invoice$ph('08-221580'),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('agical'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Invoice$pb('Agical AB'),
					_1: {
						ctor: '::',
						_0: _user$project$Invoice$ph('Västerlånggatan 79A'),
						_1: {
							ctor: '::',
							_0: _user$project$Invoice$ph('111 29 Stockholm'),
							_1: {
								ctor: '::',
								_0: _user$project$Invoice$ph('Innehar F-skattesedel'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Invoice$Invoice = function (a) {
	return {rows: a};
};
var _user$project$Invoice$HourlyReporting = function (a) {
	return {ctor: 'HourlyReporting', _0: a};
};
var _user$project$Invoice$invoiceView = F3(
	function (_p6, duration, count) {
		var _p7 = _p6;
		var rows = {
			ctor: '::',
			_0: _user$project$Invoice$HourlyReporting(
				{ctor: '_Tuple5', _0: 'Mjukvaruutveckling', _1: 1030, _2: 100, _3: 'November 2018', _4: 0}),
			_1: {ctor: '[]'}
		};
		var contract = {customer: 'Tingent', reference: 'Teodor Överli', adress: 'Regeringsgatan 74', postNumber: '111 39', county: 'Stockholm'};
		var invoice = {number: 2008, date: '2018-11-12', paymentDue: '35 dagar', reference: 'Kristoffer Roupé'};
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('btn btn-sm btn-danger'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msgs$ViewEvent(_user$project$ViewMsgs$GoHome)),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Invoice$invoiceHeader(invoice.number),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('invoice'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(_user$project$Invoice$invoiceContractDetails, invoice, contract),
								_1: {
									ctor: '::',
									_0: _user$project$Invoice$invoiceRows(
										_user$project$Invoice$Invoice(rows)),
									_1: {
										ctor: '::',
										_0: _user$project$Invoice$paymentInfoSection(
											_user$project$Invoice$Invoice(rows)),
										_1: {
											ctor: '::',
											_0: _user$project$Invoice$paymentInfo,
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							ctor: '::',
							_0: _user$project$Invoice$footer,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Invoice$DailyReporting = function (a) {
	return {ctor: 'DailyReporting', _0: a};
};

var _user$project$Last6$dayItem = function (day) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('list-group-item list-group-item-warning'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Msgs$ViewEvent(
						_user$project$ViewMsgs$EditItem(day))),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(day.dateStr),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$DateUtil$periodToStr(
								_user$project$DateUtil$toTimeDuration(day.diff))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Last6$last6 = function (sorted) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Last 6: '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Last6$dayItem,
						A2(_elm_lang$core$List$take, 6, sorted))),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$TimeSinceLastCheckIn$viewTimePeriod = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('time-period'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('period'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$TimeSinceLastCheckIn$viewTimeSinceLastCheckIn = function (t) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$TimeSinceLastCheckIn$viewTimePeriod,
		_user$project$DateUtil$timePeriods(t));
};

var _user$project$View$groupedByYear = function (events) {
	return A2(
		_elm_lang$core$List$sortWith,
		F2(
			function (_p1, _p0) {
				var _p2 = _p1;
				var _p3 = _p0;
				return A2(_user$project$Seq$desc, _p2._0, _p3._0);
			}),
		_elm_lang$core$Dict$toList(
			A2(
				_user$project$Seq$groupBy,
				function (x) {
					return _elm_lang$core$Date$year(x.inserted_at);
				},
				events)));
};
var _user$project$View$yearTab = F2(
	function (currentTab, _p4) {
		var _p5 = _p4;
		var _p6 = _p5._0;
		var active = _elm_lang$core$Native_Utils.eq(currentTab, _p6) ? ' active' : '';
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'nav-item', active)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Msgs$ViewEvent(
									_user$project$ViewMsgs$TabClicked(_p6))),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$View$sortedDayItems = function (events) {
	var grouped = A2(
		_user$project$Seq$groupBy,
		function (x) {
			return _user$project$DateUtil$dateToMonthStr(x.inserted_at);
		},
		events);
	var dayItems = A2(
		_elm_lang$core$List$map,
		function (x) {
			var date = A2(
				...
				_user$project$Types$emptyEvent,
				_elm_lang$core$List$head(
					_elm_lang$core$Tuple$second(x))).inserted_at;
			return {
				dateStr: _elm_lang$core$Tuple$first(x),
				diff: _user$project$Types$timeDifference(
					_elm_lang$core$Tuple$second(x)),
				date: date,
				dayNumber: _elm_lang$core$Date$day(date),
				events: _elm_lang$core$Tuple$second(x)
			};
		},
		_elm_lang$core$Dict$toList(grouped));
	return A2(
		_elm_lang$core$List$sortWith,
		F2(
			function (x, y) {
				return A3(_user$project$DateUtil$sortDates, _rluiten$elm_date_extra$Date_Extra_Compare$SameOrBefore, x.date, y.date);
			}),
		dayItems);
};
var _user$project$View$monthlySum = function (month) {
	return A3(
		_elm_lang$core$List$foldl,
		_user$project$DateUtil$addTimeDurations,
		_user$project$DateUtil$emptyTimeDuration,
		A2(
			_elm_lang$core$List$map,
			function (y) {
				return _user$project$DateUtil$toTimeDuration(y.diff);
			},
			month));
};
var _user$project$View$totalsRect = function (rec) {
	var data = _elm_lang$core$Tuple$second(rec);
	var year = function () {
		var _p7 = _elm_lang$core$List$head(data);
		if (_p7.ctor === 'Just') {
			return _elm_lang$core$Date$year(_p7._0.date);
		} else {
			return 0;
		}
	}();
	return {
		year: year,
		month: _elm_lang$core$Tuple$first(rec),
		total: _user$project$View$monthlySum(data),
		count: _elm_lang$core$List$length(data),
		monthlyDayCount: A2(
			_elm_lang$core$List$map,
			function (x) {
				return {hour: x.diff.hour, minute: x.diff.minute};
			},
			data)
	};
};
var _user$project$View$monthItem = function (_p8) {
	var _p9 = _p8;
	var _p13 = _p9.year;
	var _p12 = _p9.total;
	var _p11 = _p9.month;
	var _p10 = _p9.count;
	var dates = {ctor: '_Tuple2', _0: _p13, _1: _p11};
	var dayCount = _elm_lang$core$Basics$toString(_p10);
	var totalStr = _user$project$DateUtil$periodToStr(_p12);
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('list-group-item list-group-item-success row'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$DateUtil$toMonthStr(_p11),
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('list-group-item-text monthly-hours col-md-6 col-xs-6'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(totalStr),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('list-group-item-text monthly-count col-md-1 col-xs-2'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(dayCount),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('list-group-item-text col-md-1 col-xs-3'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Msgs$ViewEvent(
															A3(_user$project$ViewMsgs$CreateInvoice, dates, _p12, _p10))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Invoice'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('list-group-item-text monthly-chart col-md-8'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _user$project$Charts$barChart(_p9.monthlyDayCount),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _user$project$View$monthlyTotals = F2(
	function (active, sorted) {
		var perMonth = _elm_lang$core$Dict$toList(
			A2(
				_user$project$Seq$groupBy,
				function (x) {
					return _user$project$DateUtil$monthOrder(x.date);
				},
				sorted));
		var sortedMonthTotals = A2(
			_elm_lang$core$List$sortWith,
			F2(
				function (x, y) {
					return A2(_user$project$Seq$desc, x.month, y.month);
				}),
			A2(_elm_lang$core$List$map, _user$project$View$totalsRect, perMonth));
		var paneClass = active ? 'tab-pane active' : 'tab-pane';
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(paneClass),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					A2(_elm_lang$core$List$map, _user$project$View$monthItem, sortedMonthTotals)),
				_1: {ctor: '[]'}
			});
	});
var _user$project$View$yearTabs = F2(
	function (currentTab, events) {
		var list = _user$project$View$groupedByYear(events);
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$View$yearTab(currentTab),
						list)),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							...
							function (_p14) {
								var _p15 = _p14;
								var sorted = _user$project$View$sortedDayItems(_p15._1);
								return A2(
									_user$project$View$monthlyTotals,
									_elm_lang$core$Native_Utils.eq(_p15._0, currentTab),
									sorted);
							},
							list)),
					_1: {ctor: '[]'}
...
var _user$project$View$eventsComponent = F2(
	function (currentTab, events) {
		var monthlySorted = _user$project$View$sortedDayItems(events);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			{
				ctor: '::',
				_0: _user$project$Last6$last6(monthlySorted),
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$yearTabs, currentTab, events),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$View$view = function (model) {
	var shouldEdit = function () {
		var _p16 = model.edit;
		if (_p16.ctor === 'Just') {
			return _user$project$EditEvent$edit(_p16._0);
		} else {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
	...
	var event = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Types$emptyEvent,
		_elm_lang$core$List$head(model.events));
	var eventText = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(1000 * event.posix),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			_elm_lang$core$Basics$toString(event.inserted_at)));
	var _p17 = model.page;
	if (_p17.ctor === 'Home') {
		return A2(
			_elm_lang$html$Html$div,
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('contract-header'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											A2(_elm_lang$core$Basics_ops['++'], 'Current contract: ', model.contract.name)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('./events'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
						...
						_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Msgs$ViewEvent(_user$project$ViewMsgs$CheckIn)),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('check in'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Msgs$ViewEvent(_user$project$ViewMsgs$CheckOut)),
													_1: {ctor: '[]'}
												}
											},
											{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('row check-timer'),
										_1: {ctor: '[]'}
									},
									_user$project$TimeSinceLastCheckIn$viewTimeSinceLastCheckIn(model.timeSinceLastCheckIn)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(eventText),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: A2(_user$project$View$eventsComponent, model.currentTab, model.events),
											_1: {ctor: '[]'}
										}
									}
								}
		...
		return A3(_user$project$Invoice$invoiceView, _p17._0, _p17._1, _p17._2);
	}
};

var _user$project$InOut$init = F2(
		...
		return {
			...
			_0: A2(
				...
				location,
				{
					...
					page: _user$project$Types$Home,
					currentTab: 2019,
					contract: _user$project$Types$Contract('None')
				}),
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$project$Api$getEvents(flags.hostUrl),
					_1: {
						ctor: '::',
						_0: _user$project$Api$loadContract(flags.hostUrl),
						_1: {ctor: '[]'}
					}
				})
		};
	});
var _user$project$InOut$subscriptions = function (model) {
	var _p0 = model.checkInAt;
	if (_p0 === 0) {
		return _elm_lang$core$Platform_Sub$none;
	} else {
		return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Msgs$Tick);
	}
};
var _user$project$InOut$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_user$project$Msgs$SetRoute,
	{init: _user$project$InOut$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$InOut$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (hostUrl) {
			return _elm_lang$core$Json_Decode$succeed(
...
var Elm = {};
Elm['InOut'] = Elm['InOut'] || {};
if (typeof _user$project$InOut$main !== 'undefined') {
    _user$project$InOut$main(Elm['InOut'], 'InOut', undefined);
}
